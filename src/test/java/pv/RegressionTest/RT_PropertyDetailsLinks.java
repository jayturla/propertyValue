...
import pv.RegressionUtil.RT_PropertyDetailsLinksUtil;
...
public class RT_PropertyDetailsLinks extends TestInitReference {
	{
		System.setProperty("atu.reporter.config", "../propertyValue-automation/conf/atu.properties");
	}
	
	String testCase = "Regression Property Details Links";
		
	@Test(description="Regression Property Details Links", dataProvider = "Data-Provider-Function")
	public void testRegressionPropertyDetailsLinks(Class clzz, String[] input) {
		RT_PropertyDetailsLinksUtil pvRegression = new RT_PropertyDetailsLinksUtil(input);
		...
		try {
			...
			pvRegression.propertyReportNav(6, 1, 7, 8, 4, true);
			...
			pvRegression.titleDocumentsNav(50, 1, 51, 52, 4, true);
			...
			pvRegression.viewImage(29, 1, 30, 31, 4, true);
			//view toolip details
			...
			pvRegression.toggleMetric(53, 1, 54, 55, 4, true);
	...
	public Object[][] parameterIntTestProvider() throws IOException{
		Object[][] data = null;
		ReadXlsData rxd = new ReadXlsData("../propertyValue-automation/pvRTest-data/RTPropertyDetailsLinks.xls");
		data = rxd.getData();
		return data;
	}
