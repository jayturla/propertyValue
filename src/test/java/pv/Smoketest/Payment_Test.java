...
public class Payment_Test extends TestInitReference {
	{
		System.setProperty("atu.reporter.config", "../propertyValue-automation/conf/atu.properties");
	}
	
	String testCase = "Payment";
		
	@Test(description="Payment", dataProvider = "Data-Provider-Function")
	public void testPayment(Class clzz, String[] input) {
		PaymentUtil pvSmoke = new PaymentUtil(input);
	...
	public Object[][] parameterIntTestProvider() throws IOException{
		Object[][] data = null;
		ReadXlsData rxd = new ReadXlsData("../propertyValue-automation/pvtest-data/payment.xls");
		data = rxd.getData();
		return data;
	}
