...
public class RT07937 extends TestInitReference {
	{
	...
	public void T1534935(Class clzz, String[] input) {
		...
		try {
			...
			if(myrp.logoutUser()){
				ATUReports.add(input[1],"User Logout success",input[2], input[3], true);//pass
			}else{
				ATUReports.add(input[1],"User Logout failed ",input[2], input[4], true);//fail
			}
