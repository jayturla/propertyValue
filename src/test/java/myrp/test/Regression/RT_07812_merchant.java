...
public class RT_07812_merchant extends TestInitReference {
	...
	@Test(description="RT_07812_merchant", dataProvider = "Data-Provider-Function")
	public void RT_07927_to_RT_07930(Class clzz, String[] input) {
		...
		try {
			...
			if(myrp.PropertyReports()){
				ATUReports.add(input[1],"PROPERTY REPORTS",input[2], input[3], true);//pass
			}else{
				ATUReports.add(input[1],"PROPERTY REPORTS",input[2], input[4], true);//fail
			}
	...
	public Object[][] parameterIntTestProvider() throws IOException{
		Object[][] data = null;
		ReadXlsData rxd = new ReadXlsData("../myrp-automation/test-data/RT_07812_merchant.xls");
		data = rxd.getData();
		return data;
	}
