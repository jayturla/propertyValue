...
public class RSTabUtil extends FunctionReference {
	...
	public void reportsAndServices() throws Exception {
		pass("Test Report: RP Data Reports and Services " + browser + " browser");
		...
		try {
			...
			pass("Property Reports, Property Services, Street Reports, Suburb Reports, Infographic are displayed on Reports and Services page");
